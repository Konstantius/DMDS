function [xq,fval,exitflag,output,population,score] = StartGA(nvars,lb,ub,PopulationSize_Data, ...
...
[xq,fval,exitflag,output,population,score] = ga(@CORPEAR, nvars,[],[],[],[],lb,ub,[],[],options);
